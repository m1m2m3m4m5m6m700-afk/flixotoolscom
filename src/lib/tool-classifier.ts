...
const KEYWORDS: Record<CategoryId, string[]> = {
  translation: ["translate", "translation", "language", "arabic", "english", "french", "spanish", "subtitle", "ترجم", "ترجمة", "لغة"],
  images: ["image", "photo", "picture", "logo", "upscale", "background", "png", "jpg", "صورة", "صور"],
  pdf: ["pdf", "document", "merge", "split", "docx", "word", "مستند", "ملف pdf"],
  writing: ["write", "writing", "summarize", "summary", "rewrite", "draft", "email", "article", "blog", "grammar", "اكتب", "لخص", "كتابة"],
  ...
  converters: ["convert", "converter", "unit", "currency", "base64", "csv", "encode", "decode", "حول", "تحويل"],
  calculators: ["calculate", "calculator", "percentage", "percent", "loan", "interest", "bmi", "احسب", "حاسبة"],
