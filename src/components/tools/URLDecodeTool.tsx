...
import { Copy, Check, RefreshCw, Download, Link, AlertCircle } from "lucide-react";
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-2">
          ...
          <textarea
            ...
            placeholder="Paste URL encoded or plain text here..."
        ...
        <div className="space-y-2">
          ...
          <div className="min-h-[200px] rounded-xl border border-border bg-muted/30 p-4 font-mono text-sm overflow-y-auto whitespace-pre-wrap break-all">
            {output || error || (
              <div className="h-full flex flex-col items-center justify-center text-muted-foreground">
                <Link className="size-8 mb-2 opacity-40" />
